...
public class JsonUtils {
	...
	static {
		AbstractObjectMorpher timestampMorpher = new AbstractObjectMorpher() {
			...
			public Object morph(Object value) {
				...
				try {
					return com.ly.mp.common.utils.DateUtils.formatTimestamp(strValue);
		...
		AbstractObjectMorpher dateMorpher = new AbstractObjectMorpher() {
			...
			public Object morph(Object value) {
				...
				String strValue = (String) value;
				try {
					return new java.sql.Date(com.ly.mp.common.utils.DateUtils.formatDate(strValue).getTime());
				} catch (ParseException e) {
		...
		AbstractObjectMorpher utilDateMorpher = new AbstractObjectMorpher() {
			...
			public Object morph(Object value) {
				...
				String strValue = (String) value;
				try {
					return new Date(com.ly.mp.common.utils.DateUtils.formatDate(strValue).getTime());
				} catch (ParseException e) {
					throw new MorphException(value.getClass() + "不符合date转换格式");
				}
			}
	...
	private static JsonConfig getJsonConfig(String formatStr) {
		...
		config.registerJsonValueProcessor(Timestamp.class,jsonValueProcessor2);
		return config;
	}
