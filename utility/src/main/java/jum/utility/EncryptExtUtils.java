 ...
 * @since 产品/模块
 */
public class EncryptExtUtils {

    private static Logger log = LoggerFactory.getLogger(com.ly.mp.common.utils.EncryptExtUtils.class);
    //加密字符编解码方式
    ...
    public static String encrypt(String clearText, String passwd, String salt, String enCode) {
        ...
        try {
            ...
            String originText = clearText + salt;
            byte[] cipherBytesTmp = cipher.doFinal(originText.getBytes(enCode));
            //MD5哈希
            MessageDigest md5 = MessageDigest.getInstance("MD5");
            byte[] cipherBytes = md5.digest(cipherBytesTmp);
            //base64编码
